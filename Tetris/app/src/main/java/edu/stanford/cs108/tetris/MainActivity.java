...
public class MainActivity extends AppCompatActivity implements TetrisUIInterface {
    ...
    public void rigGameOver() {
        ...
        CheckBox brainBox = (CheckBox) findViewById(R.id.brain_check);
        brainBox.setEnabled(true);
    }
    ...
    int getTickDelay() {
        SeekBar speed = (SeekBar) findViewById(R.id.speedBar);
        int sp = speed.getProgress();
        tickDelay = 2000 - sp;
        return tickDelay;
    }
    ...
    public void onStart(View view) {
        ...
        CheckBox brainBox = (CheckBox) findViewById(R.id.brain_check);
        tetrisLogic.setMode(brainBox.isChecked());
